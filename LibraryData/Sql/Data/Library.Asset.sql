...
--NEW GUYS
 (N'quis', 1, 19, '2018-06-10', 1),
 (N'pharetra', 3, 16, '2019-05-17', 2),
 (N'fermentum donec ut', 2, 22, '2018-02-17', 1),
 (N'est phasellus sit amet', 3, 24, '2021-01-16', 1),
 (N'sit', 2, 23, '2019-04-03', 1),
 (N'scelerisque', 1, 28, '2018-11-17', 1),
 (N'nunc purus', 3, 27, '2019-11-24', 1),
 (N'justo in hac habitasse', 2, 30, '2020-06-01', 1),
 (N'id nulla', 1, 31, '2019-02-09', 1),
 (N'sit amet turpis elementum', 1, 28, '2017-08-31', 1),
 (N'volutpat sapien', 2, 31, '2020-12-13', 1),
 (N'tortor duis', 2, 30, '2017-08-10', 3),
 (N'eleifend donec', 3, 35, '2019-03-10', 1),
 (N'elit proin', 2, 46, '2020-02-21', 1),
 (N'vestibulum ante', 3, 45, '2021-01-09', 1),
 (N'justo morbi ut', 2, 41, '2020-11-23', 1),
 (N'eu orci', 4, 44, '2018-05-15', 3),
 (N'lobortis ligula sit amet', 2, 49, '2017-06-14', 2),
 (N'consectetuer eget rutrum', 3, 47, '2017-07-07', 1),
 (N'nisl nunc rhoncus', 2, 49, '2017-08-24', 1),
 (N'dapibus', 1, 61, '2020-08-25', 1),
 (N'nulla ut erat', 3, 65, '2019-09-10', 1),
 (N'sit amet', 2, 52, '2020-07-25', 1),
 (N'velit', 1, 53, '2020-12-18', 1),
 (N'nisi venenatis tristique', 3, 65, '2020-04-29', 1),
 (N'fringilla rhoncus', 1, 55, '2018-01-06', 1),
 (N'justo etiam pretium iaculis', 3, 62, '2019-10-20', 1),
 (N'ligula sit', 3, 60, '2018-01-10', 1),
 (N'vel ipsum praesent', 2, 90, '2018-02-19', 1),
 (N'tempor turpis nec', 4, 75, '2020-03-30', 1),
 (N'non', 2, 72, '2018-03-18', 1),
 (N'pede', 2, 93, '2019-10-07', 2),
 (N'eget eleifend luctus', 3, 82, '2019-02-03', 1),
 (N'quis turpis', 1, 73, '2019-02-13', 1),
 (N'ante vel ipsum praesent', 2, 83, '2020-05-13', 1),
 (N'id luctus nec', 1, 78, '2020-07-03', 1),
 (N'justo aliquam quis turpis', 1, 98, '2017-08-07', 1),
 (N'a libero', 4, 79, '2020-10-13', 1),
 (N'odio in', 2, 50, '2020-10-20', 1),
 (N'pede malesuada in', 1, 52, '2020-10-09', 3),
 (N'id consequat in', 1, 51, '2019-03-21', 1),
 (N'pede venenatis non', 2, 55, '2020-08-02', 1),
 (N'vivamus vestibulum', 4, 59, '2020-06-14', 1),
 (N'sapien ut', 2, 14, '2020-08-16', 1),
 (N'nulla neque libero convallis', 3, 57, '2019-02-21', 1),
 (N'rutrum nulla nunc purus', 4, 48, '2019-01-12', 1),
 (N'lorem integer tincidunt ante', 1, 2, '2020-12-07', 1),
 (N'potenti', 2, 5, '2018-12-22', 1),
 (N'posuere cubilia curae duis', 3, 12, '2018-12-16', 1),
 (N'rutrum rutrum neque aenean', 1, 20, '2020-06-02', 2),
 (N'sapien arcu', 1, 21, '2017-07-04', 1),
 (N'ligula pellentesque ultrices phasellus', 2, 13, '2017-06-07', 1),
 (N'ac', 4, 23, '2020-11-23', 1),
 (N'ac consequat metus', 2, 52, '2020-03-31', 1),
 (N'sodales scelerisque', 3, 17, '2018-12-09', 1),
 (N'amet lobortis sapien', 1, 87, '2018-11-06', 1),
 (N'cras non velit', 4, 23, '2018-05-10', 1),
 (N'lectus pellentesque at nulla', 2, 89, '2019-07-28', 2),
 (N'placerat praesent blandit nam', 3, 22, '2019-10-06', 1),
 (N'velit donec diam neque', 2, 91, '2017-05-16', 1),
 (N'sollicitudin', 3, 29, '2018-09-26', 1),
 (N'ornare imperdiet sapien', 1, 24, '2017-09-13', 1),
 (N'in faucibus orci luctus', 1, 94, '2019-09-26', 1),
 (N'primis in faucibus', 3, 30, '2020-04-30', 1),
 (N'justo eu massa', 4, 36, '2019-01-05', 2),
 (N'hendrerit at vulputate', 1, 97, '2019-01-05', 1),
 (N'dapibus augue', 3, 51, '2019-06-24', 1),
 (N'tempus vel', 4, 42, '2018-05-11', 1),
 (N'sed interdum venenatis turpis', 2, 100, '2019-05-27', 3),
  (N'morbi', 1, 3, '2020-10-18', 2),
 (N'congue etiam', 2, 4, '2020-01-17', 1),
 (N'magna vestibulum', 1, 6, '2018-05-09', 1),
 (N'tempor turpis', 4, 9, '2019-05-25', 1),
 (N'nulla', 1, 11, '2019-10-04', 2),
 (N'ultrices phasellus id sapien', 4, 13, '2018-02-08', 1),
 (N'purus', 2, 14, '2017-06-24', 1),
 (N'elit ac nulla', 1, 18, '2019-07-13', 1),
 (N'malesuada', 4, 20, '2019-08-17', 1),
 (N'nullam varius nulla', 4, 25, '2019-01-29', 1),
 (N'in', 1, 28, '2017-09-01', 1),
 (N'nisl aenean lectus pellentesque', 3, 27, '2018-08-24', 1),
 (N'amet lobortis sapien', 2, 30, '2017-09-21', 1),
 (N'cras non velit', 1, 31, '2019-01-27', 1),
 (N'rutrum at lorem integer', 3, 39, '2019-10-03', 2),
 (N'in lacus curabitur at', 1, 41, '2018-11-29', 1),
 (N'pretium', 2, 46, '2019-08-08', 1),
 (N'orci luctus et ultrices', 2, 49, '2018-02-13', 1),
 (N'luctus cum sociis', 1, 50, '2020-05-16', 3),
 (N'mauris sit amet', 3, 56, '2019-02-03', 1),
 (N'adipiscing', 4, 58, '2020-06-06', 1),
 (N'vestibulum sagittis sapien cum', 1, 51, '2017-07-19', 1),
 (N'eget congue eget semper', 1, 52, '2017-11-23', 1),
 (N'velit donec', 1, 53, '2021-02-28', 1),
 (N'lectus in quam fringilla', 1, 54, '2020-01-27', 1),
 (N'neque sapien placerat ante', 3, 57, '2017-12-18', 2),
 (N'nibh in', 4, 92, '2017-11-16', 1),
 (N'nisl ut volutpat sapien', 4, 96, '2020-01-25', 1),
 (N'nam congue risus', 3, 91, '2019-10-08', 1),
 (N'pede malesuada in', 3, 95, '2018-01-04', 1),
 (N'sapien cum sociis natoque', 2, 88, '2017-05-16', 1),
 (N'neque', 2, 89, '2019-05-31', 1),
 (N'nibh', 4, 100, '2019-10-11', 1),
 (N'justo aliquam quis turpis', 1, 98, '2017-11-29', 1),
 (N'sapien', 4, 4, '2020-08-12', 1),
 (N'elit proin risus', 1, 99, '2020-05-22', 2),
 (N'rhoncus', 1, 2, '2018-12-13', 1),
 (N'parturient montes nascetur ridiculus', 1, 5, '2020-01-31', 1),
 (N'consequat nulla nisl', 2, 15, '2020-12-10', 1),
 (N'nullam molestie nibh in', 4, 23, '2018-03-30', 1),
 (N'laoreet ut rhoncus', 1, 20, '2020-03-03', 1),
 (N'iaculis congue', 4, 36, '2020-12-21', 1),
 (N'in sagittis dui vel', 2, 13, '2021-02-28', 1),
 (N'risus praesent lectus vestibulum', 1, 15, '2019-01-06', 1),
 (N'et ultrices', 1, 77, '2018-04-08', 1),
 (N'interdum venenatis', 2, 79, '2018-07-03', 1),
 (N'aliquam', 3, 86, '2020-11-15', 1),
 (N'in libero ut', 3, 71, '2019-06-06', 1),
 (N'metus sapien', 1, 79, '2018-12-18', 3);
